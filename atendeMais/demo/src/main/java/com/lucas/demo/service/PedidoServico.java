...
public class PedidoServico {
	...
	protected void carregarPedidosDeArquivo(String caminhoArquivo) throws ErroArquivoException {
	...
	private String caminhoArquivo(LocalDate data) {
		...
		// System.out.println("caminho aquirvo1");

		// return diretorioPrincipal + "/atendeMais/registros/pedidos/pedidos_" + data +
		// ".json"; nao usavel

		// return "/home/atendeMais/registros/pedidos/pedidos_" + data + ".json";

		// return diretorioPrincipal + "\\registros\\pedidos\\pedidos_" + data +
		// ".json";

		String caminhoArq = MudancaSO.separatorParaPedidos();
	...
	private String verificarHora() {
		// String diretorioAtual = System.getProperty("user.dir");
		// System.out.println("caminho verificar hora1");
		// File diretorioPrincipal = new File(diretorioAtual).getParentFile();

		// String caminhoAr = diretorioPrincipal +
		// "/atendeMais/registros/pedidos/pedidos_"; nao usavel

		// String caminhoAr = "/home/atendeMais/registros/pedidos/pedidos_";

		// String caminhoAr = diretorioPrincipal + "\\registros\\pedidos\\pedidos_";

		String caminhoAr = MudancaSO.separatorParaPedidos();
